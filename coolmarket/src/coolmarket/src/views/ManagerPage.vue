<template>
  <b-tabs content-class="mt-3" fill>
    <b-tab title="마켓 신고" active>
      <div class="mt-5">
        <div class="d-flex justify-content-end m-2">
          <b-button variant="danger" v-on:click="marAllDel">일괄삭제</b-button>
        </div>
        <div v-if="marDec == ''">
    ...
    <b-tab title="커뮤니티 신고">
      <div class="mt-5">
        <div class="d-flex justify-content-end m-2">
          <b-button variant="danger" v-on:click="comAllDel">일괄삭제</b-button>
        </div>
        <div v-if="comDec == ''">
          <h3 class="text-center">신고된 게시물이 없습니다.</h3>
        </div>
    ...
    <b-tab title="프리미엄 회원">
      <div class="mt-5">
        <table class="table table-hover">
          ...
          <tbody>
            <tr v-if="premiumUser == ''">
              <td colspan="5" class="text-center">프리미엄 회원이 없습니다.</td>
            </tr>
